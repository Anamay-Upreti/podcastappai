...
import cn from 'classnames'; // Assuming cn is a utility function for conditional class names
  ...
  return (
    <section className="left_sidebar">
      <nav className="flex flex-col gap-6">
        <a href="/" className="flex cursor-pointer items-center gap-1 pb-10 max-lg:justify-center">
          <Image
            src="/icons/logo.svg"
            alt="logo"
            width={23}
